...
func TestPasswordResetTokenRepository_GetByToken(t *testing.T) {
	...
	tokenRepo := NewPasswordResetTokenRepository(testDB.DB)
...
func TestPasswordResetTokenRepository_GetValidTokenByUserID(t *testing.T) {
	testDB := testutil.NewTestDB(t)
	defer testDB.Close()
...
func TestPasswordResetTokenRepository_MarkTokenAsUsed(t *testing.T) {
	testDB := testutil.NewTestDB(t)
	defer testDB.Close()
...
func TestPasswordResetTokenRepository_RevokeAllUserTokens(t *testing.T) {
	testDB := testutil.NewTestDB(t)
	defer testDB.Close()
	...
	token1 := &model.PasswordResetToken{
	...
	token3 := &model.PasswordResetToken{
...
func TestPasswordResetTokenRepository_GetValidToken(t *testing.T) {
	testDB := testutil.NewTestDB(t)
	defer testDB.Close()
