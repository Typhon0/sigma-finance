	...
	tests := []struct {
		...
		},
		{
			...
			transaction: &Transaction{
				...
				PricePerUnit:    decimalPtr(decimal.NewFromFloat(0.60)),
				Fee:             Money(0),
				TransactionDate: now,
				CreatedAt:       now,
			},
		...
		},
		{
			...
			transaction: &Transaction{
				...
				Type:            TransactionTypeBuy,
				Amount:          Money(5000),
				PricePerUnit:    decimalPtr(decimal.NewFromFloat(50.0)),
				TransactionDate: now,
				CreatedAt:       now,
			},
			wantErr: true,
		...
		},
		{
			...
			transaction: &Transaction{
				...
				Quantity:        decimalPtr(decimal.NewFromFloat(50.0)),
				PricePerUnit:    decimalPtr(decimal.NewFromFloat(60.0)),
				TransactionDate: now,
				CreatedAt:       now,
			},
			wantErr: true,
		...
		},
		{
			...
			transaction: &Transaction{
				...
				Amount:          Money(10000),
				Fee:             Money(0),
				TransactionDate: now.AddDate(0, 0, 2), // 2 days in future
				CreatedAt:       now,
			},
			wantErr: true,
