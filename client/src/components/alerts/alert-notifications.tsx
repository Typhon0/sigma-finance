        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {unacknowledgedNotifications.length} unacknowledged notification{unacknowledgedNotifications.length !== 1 ? 's' : ''}
            </span>
          </div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark all {unacknowledgedNotifications.length} unacknowledged notifications as read.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      {unacknowledgedNotifications.length > 0 && (
        <div className="space-y-3">
          ...
          {unacknowledgedNotifications.map((notification) => (
            <Card key={notification.id} className={`border-l-4 ${getPriorityColor(notification.alertType)}`}>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="space-y-2">
                      ...
                      {(notification.currentValue !== undefined || notification.thresholdValue !== undefined) && (
