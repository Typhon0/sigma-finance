    ...
    <div className={`space-y-4 ${className}`}>
      ...
      {showFilters && (
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            <Select value={filterType} onValueChange={(value) => handleFilterChange(value, filterStatus)}>
            ...
            <Select value={filterStatus} onValueChange={(value) => handleFilterChange(filterType, value)}>
      ...
      <div className="space-y-3">
        {filteredAlerts.map((alert) => (
          <Card key={alert.id} className={`transition-colors ${!alert.isActive ? 'opacity-60' : ''}`}>
