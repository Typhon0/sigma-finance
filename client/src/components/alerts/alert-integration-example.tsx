...
const examplePortfolios: Portfolio[] = [
  { id: '1', name: 'Main Portfolio', description: 'Primary investment portfolio' },
  { id: '2', name: 'Retirement Fund', description: '401k and IRA investments' },
  { id: '3', name: 'Crypto Portfolio', description: 'Cryptocurrency investments' },
];

const exampleAssets: Asset[] = [
  { id: '1', name: 'Apple Inc.', symbol: 'AAPL', type: 'STOCK', currentPrice: 145.50 },
  { id: '2', name: 'Bitcoin', symbol: 'BTC', type: 'CRYPTO', currentPrice: 42000 },
  { id: '3', name: 'Tesla Inc.', symbol: 'TSLA', type: 'STOCK', currentPrice: 180.25 },
  { id: '4', name: 'Ethereum', symbol: 'ETH', type: 'CRYPTO', currentPrice: 2500 },
];
...
export function AlertIntegrationExample() {
  ...
  const handleCreateAlert = async (data: AlertFormData) => {
    const newAlert: Alert = {
      ...
      portfolio: data.portfolioId ? examplePortfolios.find(p => p.id === data.portfolioId) : undefined,
    };
        ...
        <CardContent className="space-y-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              ...
              The alert management system is designed to work seamlessly with the dashboard-centric architecture.
            </p>
          </div>
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            ...
            <p className="text-sm text-green-800">
              Use the AlertQuickSetup component for context-aware alert creation from portfolio and asset views.
            </p>
          </div>
          ...
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            ...
            <p className="text-sm text-purple-800">
              The AlertManagement component provides comprehensive alert configuration, monitoring, and testing capabilities.
            </p>
          </div>
        </CardContent>
      </Card>
