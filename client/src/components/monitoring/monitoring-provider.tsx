...
interface MonitoringContextType {
  ...
  trackDataLoad: (dataType: string, startTime: number, success: boolean, error?: Error) => void;
  trackUserInteraction: (action: string, component: string, additionalData?: any) => void;
  trackMarketDataUpdate: (source: string, assetCount: number, duration: number, success: boolean) => void;
...
export function useActionTracking() {
  ...
  const trackFormSubmit = (formName: string, success: boolean, additionalData?: any) => {
