...
const mockPortfolio: Portfolio = {
  ...
  user: { id: '1', name: 'John Doe', email: 'john@example.com', emailVerified: true },
  assets: [],
  analytics: null,
      ...
      <Card>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              This is a demonstration of the transaction management interface integrated with the dashboard.
              In the real application, this would connect to GraphQL resolvers for data persistence.
            </AlertDescription>
          </Alert>
            ...
            <Card>
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-purple-600">
                  ${mockPositions.reduce((sum, p) => sum + (p.quantity * (p.asset.currentValue || 0)), 0).toLocaleString()}
                </div>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              ...
              <Badge variant="outline" className="bg-yellow-100 text-yellow-800">Pending Task 9</Badge>
            </div>
          </div>
        </CardContent>
      </Card>
