			...
			{allItems.map((item) => (
				...
				>
					<div className="flex items-center gap-2">
						...
						<Badge
							variant={item.type === "portfolio" ? "default" : "secondary"}
							className="text-xs"
						>
							{item.type}
						</Badge>
					...
					<div className="text-right">
						<p
							className={cn(
								"font-medium",
								getPerformanceColorClass(item.change),
								compact && "text-sm",
							)}
						>
					...
					<div className="text-right">
						<p
							className={cn(
								"font-medium",
								getPerformanceColorClass(item.changePercent),
								compact && "text-sm",
							)}
						>
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t">
						...
						<div className="text-center">
							...
							<p className="font-semibold">
								{(() => {
									const avg =
										[...portfolioData, ...benchmarks].reduce(
