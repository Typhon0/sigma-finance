...
export function DashboardStatusAnnouncer({
	...
	return <AccessibilityAnnouncer message={announcement} clearAfter={5000} />;
}
...
export function NavigationAnnouncer({
	...
	return <AccessibilityAnnouncer message={announcement} clearAfter={2000} />;
}
...
export function ErrorAnnouncer({
	...
	return <AccessibilityAnnouncer message={announcement} clearAfter={6000} />;
}
...
export function SuccessAnnouncer({ message }: { message?: string }) {
	return <AccessibilityAnnouncer message={message || ""} clearAfter={3000} />;
}
