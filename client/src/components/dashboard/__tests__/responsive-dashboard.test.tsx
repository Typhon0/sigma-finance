...
function TestResponsiveDashboard() {
	...
	return (
		<div>
			...
			<button
				type="button"
				onClick={() => actions.handleSwipeGesture("right")}
			...
			<button
				type="button"
				onClick={() => actions.handleSwipeGesture("left")}
...
function TestTouchGestures() {
	...
	return <div data-testid="touch-area">Touch area for gesture testing</div>;
}
