...
// Mock chart component to avoid ECharts complexity
...
vi.mock('@/lib/chart-colors', () => ({
  getAssetTypeColor: (assetType: string) => '#3b82f6',
}))
...
describe('Dashboard Integration Tests - Task 13.1', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  describe('Apollo Client Integration Simulation', () => {
    it('should handle data loading states properly', () => {
      // Simulate Apollo loading state
      const { rerender } = render(
        <PortfolioOverview
          totalValue={0}
          totalChange={0}
    ...
    it('should handle data updates efficiently', () => {
      ...
      // Simulate data update (like from Apollo polling)
      rerender(
        <PortfolioOverview
          totalValue={127500}
          totalChange={5000}
