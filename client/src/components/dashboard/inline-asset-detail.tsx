import { ArrowLeft, Edit, Trash2, TrendingUp, TrendingDown, DollarSign, Calendar } from 'lucide-react';
...
function TransactionHistory({ assetId }: TransactionHistoryProps) {
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className={`flex items-center gap-2 ${priceChange >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {priceChange >= 0 ? (
