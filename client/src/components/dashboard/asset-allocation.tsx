...
import { PieChart, BarChart3, TrendingUp, AlertCircle, Target, Lightbulb } from 'lucide-react';
...
const AllocationBreakdown: React.FC<{
  ...
  compact?: boolean;
  onAssetTypeClick?: (assetType: string) => void;
}> = ({ allocations, totalValue, compact = false, onAssetTypeClick }) => {
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              <div
                ...
                style={{ backgroundColor: allocation.color || getAssetTypeColor(allocation.assetType) }}
              />
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Progress 
                    ...
                    style={{
                      '--progress-background': allocation.color || getAssetTypeColor(allocation.assetType)
  ...
  return (
    <div className="space-y-3">
      {sortedRecommendations.map((recommendation, index) => (
        <Card key={`${recommendation.assetType}-${index}`} className="border-l-4" style={{
          borderLeftColor: recommendation.priority === 'high' ? '#ef4444' : 
