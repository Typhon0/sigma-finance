...
import { TrendingUp, BarChart3, Target, Bell, FileText, Settings } from 'lucide-react';
...
import AssetAllocation, { type AllocationItem, type AllocationRecommendation } from './asset-allocation';
import PerformanceComparison, { type BenchmarkData, type PortfolioPerformanceData } from './performance-comparison';
import PerformanceReports, { type ReportData, type ReportConfig } from './performance-reports';
import PerformanceAlerts, { type PerformanceAlert, type AlertFormData } from './performance-alerts';
...
export const PerformanceDashboard: React.FC<PerformanceDashboardProps> = ({
  ...
  const summaryStats = useMemo(() => {
    ...
    const recentlyTriggered = data.alerts.filter(a => 
    ...
    <div className={cn("space-y-6", className)}>
      ...
      {summaryStats && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <p className="text-2xl font-bold text-purple-600">{summaryStats.highPriorityRecommendations}</p>
