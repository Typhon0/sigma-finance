...
import { RealTimeAlertNotifications, FloatingAlertNotification } from '@/components/alerts/RealTimeAlertNotifications';
...
function DashboardOverview({ portfolios, onPortfolioSelect }: DashboardOverviewProps) {
  return (
