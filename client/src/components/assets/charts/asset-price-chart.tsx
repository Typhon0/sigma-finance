...
export function AssetPriceChart({
  ...
  const priceChangeInfo = currentPrice ? formatPriceChange(currentPrice.change, currentPrice.changePercent) : null;
 ...
 */
export function CompactAssetPriceChart(props: Omit<AssetPriceChartProps, 'compact' | 'showControls'>) {
  return (
    <AssetPriceChart
      {...props}
      compact={true}
 ...
 */
export type { PricePoint, AssetPrice, PriceUpdate };