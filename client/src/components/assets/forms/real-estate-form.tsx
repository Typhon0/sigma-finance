...
const realEstateSchema = z.object({
  ...
  ownershipPercentage: z.number().min(0.01, 'Ownership must be at least 0.01%').max(100, 'Ownership cannot exceed 100%'),
...
export function RealEstateForm({ onSubmit, onCancel, isLoading, initialData }: RealEstateFormProps) {
