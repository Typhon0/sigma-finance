...
import { Watch, Gem } from 'lucide-react';
...
const WATCH_BRANDS = [
  ...
  'Panerai', 'Hublot', 'Richard Mille', 'Tudor', 'Seiko', 'Casio', 'Other'
];
...
const MATERIALS = [
  ...
  'Titanium', 'Ceramic', 'Carbon Fiber', 'Leather', 'Rubber', 'Other'
];

const MOVEMENTS = [
  'Automatic', 'Manual', 'Quartz', 'Solar', 'Kinetic', 'Spring Drive', 'Other'
];
