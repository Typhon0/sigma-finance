...
function Command({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) {
	return (
		<CommandPrimitive data-slot="command" className={cn("ui-command", className)} {...props} />
	);
}
...
function CommandDialog({
	...
	return (
		<Dialog {...props}>
			...
			>
				<Command className="ui-command-dialog">{children}</Command>
			</DialogContent>
		</Dialog>
	);
}
...
function CommandEmpty({ ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) {
	return (
		<CommandPrimitive.Empty data-slot="command-empty" className="ui-command-empty" {...props} />
	);
}
