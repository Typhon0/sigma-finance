...
import { Plus, DollarSign, Hash, Calendar, Zap } from 'lucide-react';
...
const quickTransactionTypes: { value: TransactionType; label: string; color: string }[] = [
  ...
  { value: 'WITHDRAWAL', label: 'Withdrawal', color: 'bg-orange-100 text-orange-800' },
];
          ...
          <div className="p-3 bg-muted/30 rounded-lg">
            <div className="flex items-center justify-between text-sm">
              ...
              <Badge variant="outline" className={
                transactionType === 'BUY' ? 'text-green-700' :
                transactionType === 'SELL' ? 'text-red-700' :
                'text-blue-700'
              }>
                {transactionType}
              </Badge>
