...
import PortfolioComparisonChart, { type PortfolioComparisonChartProps } from './PortfolioComparisonChart';
 ...
 */
export interface CompactPerformanceChartProps extends Omit<PerformanceChartProps, 'height' | 'compact' | 'showHeader' | 'showFullscreen'> {
  height?: number;
  showTitle?: boolean;
}
 ...
 */
export interface CompactAllocationChartProps extends Omit<AllocationChartProps, 'height' | 'compact' | 'showHeader' | 'showFullscreen'> {
  height?: number;
  showTitle?: boolean;
}
 ...
 */
export interface CompactPortfolioComparisonChartProps extends Omit<PortfolioComparisonChartProps, 'height' | 'compact' | 'showHeader' | 'showFullscreen'> {
  height?: number;
  showTitle?: boolean;
}
