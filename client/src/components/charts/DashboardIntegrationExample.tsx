...
const mockAllocation: AllocationDataPoint[] = [
  { name: 'Technology Stocks', value: 45000, assetType: 'STOCK', percentage: 42.9 },
  { name: 'Cryptocurrency', value: 25000, assetType: 'CRYPTO', percentage: 23.8 },
  { name: 'Real Estate', value: 20000, assetType: 'REAL_ESTATE', percentage: 19.0 },
  { name: 'Cash & Equivalents', value: 15000, assetType: 'BANK_ACCOUNT', percentage: 14.3 },
];
