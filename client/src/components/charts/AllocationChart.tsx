...
import { Download, Maximize2, Minimize2, PieChart, Grid3X3 } from 'lucide-react';
import { 
...
const AllocationChart: React.FC<AllocationChartProps> = ({
  ...
  const chartOption = useMemo((): EChartsOption => {
    ...
    return baseConfig;
  }, [processedData, currentChartType, title, showHeader, showPercentage, compact, interactive, onSegmentClick]);
