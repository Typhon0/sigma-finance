...
describe('Authentication Error Handling Components', () => {
  ...
  describe('AuthSuccessDisplay', () => {
    it('displays registration success message', () => {
      ...
      expect(screen.getByText(/verification email has been sent to test@example.com/i)).toBeInTheDocument();
    });
    ...
    it('displays password reset success message', () => {
      ...
      expect(screen.getByText(/password reset link has been sent to test@example.com/i)).toBeInTheDocument();
    });
  });
