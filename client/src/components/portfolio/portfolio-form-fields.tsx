...
export function PortfolioFormFields({
  ...
  const nameSuggestions = useMemo(() => {
    if (!showNameSuggestions || !watchedName || nameValidationError !== portfolioErrorMessages.nameExists) {
      return [];
    }
...
export interface PortfolioNameFieldProps extends Omit<PortfolioFormFieldsProps, 'showNameSuggestions'> {
...
export function PortfolioNameField({
  ...
  const nameSuggestions = useMemo(() => {
    if (!showSuggestions || !watchedName || nameValidationError !== portfolioErrorMessages.nameExists) {
      return [];
    }
    return portfolioValidationHelpers.generateNameSuggestions(
      watchedName,
