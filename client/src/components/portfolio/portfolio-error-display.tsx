        ...
        <Card className="border-destructive/50">
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                This portfolio belongs to another user. You can only view and manage your own portfolios.
              </AlertDescription>
            </Alert>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                The portfolio you're looking for may have been deleted, moved, or you may not have permission to access it.
              </AlertDescription>
            </Alert>
