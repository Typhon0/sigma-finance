...
export function PortfolioFormExamples() {
  const [portfolios, setPortfolios] = useState([
    { id: '1', name: 'Tech Stocks', description: 'Technology focused portfolio' },
    { id: '2', name: 'Dividend Growth', description: 'Dividend growth strategy' },
  ]);
          ...
          <div className="flex gap-4">
            ...
            {portfolios.length > 0 && (
              <EditPortfolioDialog
                ...
                onSubmit={(data) => handleUpdatePortfolio(portfolios[0].id, data)}
                existingPortfolioNames={existingNames}
                onSuccess={handleSuccess}
                onError={handleError}
              >
