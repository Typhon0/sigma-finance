...
import { ExportType, ExportFormat } from '@/lib/export/types';
...
export function ExportDialog({
  ...
  const exportTypes = [
    { value: 'portfolio-data', label: 'Portfolio Data', requiresPortfolio: true },
    { value: 'transaction-history', label: 'Transaction History', requiresPortfolio: true },
    { value: 'performance-analytics', label: 'Performance Analytics', requiresPortfolio: true },
    { value: 'tax-report', label: 'Tax Report', requiresPortfolio: false },
    { value: 'audit-trail', label: 'Audit Trail', requiresPortfolio: false },
    { value: 'data-backup', label: 'Complete Data Backup', requiresPortfolio: false },
  ] as const;

  const formatOptions = [
    { value: 'csv', label: 'CSV', supportedTypes: ['portfolio-data', 'transaction-history', 'tax-report', 'audit-trail'] },
    { value: 'pdf', label: 'PDF', supportedTypes: ['portfolio-data', 'performance-analytics', 'tax-report'] },
    { value: 'json', label: 'JSON', supportedTypes: ['portfolio-data', 'transaction-history', 'tax-report', 'audit-trail', 'data-backup'] },
  ] as const;
  ...
  const requiresDateRange = ['transaction-history', 'audit-trail', 'tax-report'].includes(exportType);
      ...
      switch (exportType) {
        ...
        case 'transaction-history':
          result = await ExportService.exportTransactionHistory(
            portfolioId!,
            dateRange.start && dateRange.end ? dateRange as { start: Date; end: Date } : undefined,
            format
          );
          break;
        case 'tax-report':
