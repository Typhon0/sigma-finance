...
export { createChart, ColorType, CrosshairMode, LineStyle, PriceScaleMode };
 ...
 */
export function getDefaultCandlestickOptions(theme: ChartTheme): DeepPartial<CandlestickSeriesOptions> {
  return {
 ...
 */
export function getDefaultLineOptions(theme: ChartTheme, color?: string): DeepPartial<LineSeriesOptions> {
  return {
 ...
 */
export function getDefaultAreaOptions(theme: ChartTheme, color?: string): DeepPartial<AreaSeriesOptions> {
...
export class ChartPerformanceManager {
   ...
   */
  static sampleData<T extends { time: any }>(data: T[], maxPoints: number = this.MAX_DATA_POINTS): T[] {
  ...
  static shouldSampleData(dataLength: number): boolean {
    return dataLength > this.SAMPLE_THRESHOLD;
  }
