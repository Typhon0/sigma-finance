...
interface IBasicDataFeed {
  ...
  searchSymbols(userInput: string, exchange: string, symbolType: string, callback: SearchSymbolsCallback): void;
  resolveSymbol(symbolName: string, onSymbolResolvedCallback: ResolveCallback, onResolveErrorCallback: ErrorCallback): void;
  getBars(symbolInfo: LibrarySymbolInfo, resolution: ResolutionString, periodParams: PeriodParams, onHistoryCallback: HistoryCallback, onErrorCallback: ErrorCallback): void;
  subscribeBars(symbolInfo: LibrarySymbolInfo, resolution: ResolutionString, onRealtimeCallback: SubscribeBarsCallback, subscriberUID: string, onResetCacheNeededCallback?: () => void): void;
...
class MarketDataFeed implements IBasicDataFeed {
  ...
  private getPopularSymbols(exchange: string) {
    if (exchange === 'CRYPTO') {
      return [
        { symbol: 'BTC/USDT', full_name: 'Bitcoin/Tether', description: 'Bitcoin vs Tether', exchange: 'CRYPTO', type: 'crypto' },
        { symbol: 'ETH/USDT', full_name: 'Ethereum/Tether', description: 'Ethereum vs Tether', exchange: 'CRYPTO', type: 'crypto' },
        { symbol: 'BNB/USDT', full_name: 'Binance Coin/Tether', description: 'Binance Coin vs Tether', exchange: 'CRYPTO', type: 'crypto' },
        { symbol: 'ADA/USDT', full_name: 'Cardano/Tether', description: 'Cardano vs Tether', exchange: 'CRYPTO', type: 'crypto' },
        { symbol: 'SOL/USDT', full_name: 'Solana/Tether', description: 'Solana vs Tether', exchange: 'CRYPTO', type: 'crypto' },
      ];
    } else {
      return [
        { symbol: 'AAPL', full_name: 'Apple Inc.', description: 'Apple Inc.', exchange: 'STOCK', type: 'stock' },
        { symbol: 'MSFT', full_name: 'Microsoft Corporation', description: 'Microsoft Corporation', exchange: 'STOCK', type: 'stock' },
        { symbol: 'GOOGL', full_name: 'Alphabet Inc.', description: 'Alphabet Inc.', exchange: 'STOCK', type: 'stock' },
        { symbol: 'AMZN', full_name: 'Amazon.com Inc.', description: 'Amazon.com Inc.', exchange: 'STOCK', type: 'stock' },
        { symbol: 'TSLA', full_name: 'Tesla Inc.', description: 'Tesla Inc.', exchange: 'STOCK', type: 'stock' },
      ];
    }
  }
}
