...
import { Portfolio, Position, Asset, AssetType } from '@/lib/types/dashboard.types'
...
describe('Portfolio Calculations', () => {
  ...
  describe('getTopPerformingAssets', () => {
    it('should return top performing assets sorted by percentage', () => {
      const performances = [
        { asset: mockAsset, currentValue: 100, changeAmount: 50, changePercent: 50, positions: [] },
        { asset: mockAsset, currentValue: 100, changeAmount: 20, changePercent: 20, positions: [] },
        { asset: mockAsset, currentValue: 100, changeAmount: 80, changePercent: 80, positions: [] },
      ]
