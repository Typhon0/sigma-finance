...
export const transactionFormSchema = z.object({
  ...
  transactionType: z.enum(['BUY', 'SELL', 'DEPOSIT', 'WITHDRAWAL', 'TRANSFER_IN', 'TRANSFER_OUT', 'DIVIDEND', 'INTEREST', 'FEE', 'ADJUSTMENT'], {
...
export const bulkTransactionSchema = z.object({
  portfolioId: z.string().min(1, "Portfolio is required"),
  transactions: z.array(transactionFormSchema.omit({ portfolioId: true })).min(1, "At least one transaction is required"),
...
export const transactionFilterSchema = z.object({
  ...
  assetId: z.string().optional(),
  transactionType: z.enum(['BUY', 'SELL', 'DEPOSIT', 'WITHDRAWAL', 'TRANSFER_IN', 'TRANSFER_OUT', 'DIVIDEND', 'INTEREST', 'FEE', 'ADJUSTMENT']).optional(),
