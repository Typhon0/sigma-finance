  ...
  return (
    <BrowserRouter>
      <MockedProvider mocks={mocks} addTypename={false}>
        <AuthProvider value={{ user: mockUser, isLoading: false, login: vi.fn(), logout: vi.fn() }}>
...
describe('Dashboard Workflow E2E Tests', () => {
      ...
      render(
        <BrowserRouter>
          <MockedProvider mocks={errorMocks} addTypename={false}>
            <AuthProvider value={{ user: { id: 'test-user-id' }, isLoading: false, login: vi.fn(), logout: vi.fn() }}>
              <ThemeProvider defaultTheme="light" storageKey="test-theme">
                <DashboardHomePage />
              </ThemeProvider>
            </AuthProvider>
  ...
  describe('Responsive Behavior During Navigation', () => {
    ...
    it('should handle touch gestures for navigation', async () => {
      ...
      fireEvent.touchStart(portfolioDetail!, { touches: [{ clientX: 0, clientY: 0 }] });
      fireEvent.touchMove(portfolioDetail!, { touches: [{ clientX: 100, clientY: 0 }] });
