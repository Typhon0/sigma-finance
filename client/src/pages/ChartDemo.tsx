          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              ...
              <Select value={selectedSymbol} onValueChange={handleSymbolChange}>
                ...
                <SelectContent>
                  <SelectItem value="BTC" disabled>Cryptocurrencies</SelectItem>
                  {cryptoSymbols.map((symbol) => (
                    <SelectItem key={symbol.symbol} value={symbol.symbol}>
                      {symbol.name} ({symbol.symbol.split(':')[0]})
                    </SelectItem>
                  ))}
                  <SelectItem value="stock" disabled>Stocks</SelectItem>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm text-blue-700">
              ...
              <p>2. Extract to <code className="bg-blue-100 px-1 rounded">client/public/charting_library/</code></p>
