...
export type DuplicatePortfolioMutation = {
	__typename?: "Mutation";
	duplicatePortfolio: {
		__typename?: "Portfolio";
		id: string;
...
export type GetDashboardCriticalQuery = {
	...
	watchlists: Array<{ __typename?: "Watchlist"; id: string; name: string }>;
};
...
export type GetDashboardSecondaryQuery = {
	__typename?: "Query";
	transactions: Array<{
		__typename?: "Transaction";
		id: string;
...
export type GetRecentTransactionsMinimalQuery = {
	__typename?: "Query";
	transactions: Array<{
		__typename?: "Transaction";
		id: string;
...
export type GetAssetPerformanceOptimizedQuery = {
	__typename?: "Query";
	assets: Array<
		| {
				__typename?: "Crypto";
...
export type GetPortfoliosWithAnalyticsQuery = {
	__typename?: "Query";
	portfolios: Array<{
		__typename?: "Portfolio";
		id: string;
		...
		assets: Array<{
			...
			asset:
				| {
						...
						symbol?: string | null;
						currentValue?: number | null;
						assetType: { __typename?: "AssetType"; name: string };
				  }
				| {
						__typename?: "Stock";
						name: string;
...
export type PortfolioUpdateSubscriptionSubscription = {
	__typename?: "Subscription";
	portfolioUpdates: {
		__typename?: "PortfolioUpdatePayload";
		type: string;
		portfolio: { __typename?: "Portfolio"; id: string; name: string };
	};
};
...
export type GetAssetsQuery = {
	...
	assets: Array<
		| {
				...
				symbol?: string | null;
				currentValue?: number | null;
				assetType: { __typename?: "AssetType"; id: string; name: string };
		  }
		| {
				__typename?: "Stock";
				id: string;
...
export type GetAssetTypesQuery = {
	__typename?: "Query";
	assetTypes: Array<{ __typename?: "AssetType"; id: string; name: string }>;
};
...
export type AddAssetToPortfolioMutation = {
	__typename?: "Mutation";
	addAssetToPortfolio: {
		__typename?: "PortfolioAsset";
		quantity: number;
...
export type RemoveAssetFromPortfolioMutation = {
	__typename?: "Mutation";
	removeAssetFromPortfolio: string;
};
...
export type PortfolioFieldsFragment = {
	...
	createdAt: any;
	updatedAt: any;
} & { " $fragmentName"?: "PortfolioFieldsFragment" };

export const PortfolioFieldsFragmentDoc = {
	kind: "Document",
	definitions: [
		{
			kind: "FragmentDefinition",
			name: { kind: "Name", value: "PortfolioFields" },
			typeCondition: {
				kind: "NamedType",
...
} as unknown as DocumentNode<PortfolioFieldsFragment, unknown>;
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "PasswordResetConfirmInput" },
						},
					},
				},
			],
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "EmailVerificationInput" },
						},
					},
				},
			],
...
>;
export const DuplicatePortfolioDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			...
			variableDefinitions: [
				{
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "DuplicatePortfolioInput" },
						},
					},
				},
			],
...
export const GetDashboardCriticalDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetDashboardCritical" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
								...
								{ kind: "Field", name: { kind: "Name", value: "name" } },
								{
									...
									selectionSet: {
										...
										selections: [
											{
												kind: "Field",
												name: { kind: "Name", value: "totalValue" },
											},
										],
									},
								},
	...
	GetDashboardCriticalQuery,
	GetDashboardCriticalQueryVariables
>;
export const GetDashboardSecondaryDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetDashboardSecondary" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "transactionDate" },
								},
							],
						},
					},
	...
	GetDashboardSecondaryQuery,
	GetDashboardSecondaryQueryVariables
>;
export const GetPortfolioCardsDocument = {
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetPortfolioCards" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
								...
								{ kind: "Field", name: { kind: "Name", value: "name" } },
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "totalGainLossPercent" },
											},
										],
									},
								},
	...
	GetPortfolioCardsQuery,
	GetPortfolioCardsQueryVariables
>;
export const GetRecentTransactionsMinimalDocument = {
	...
	GetRecentTransactionsMinimalQuery,
	GetRecentTransactionsMinimalQueryVariables
>;
export const GetAssetPerformanceOptimizedDocument = {
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetAssetPerformanceOptimized" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
	...
	GetAssetPerformanceOptimizedQuery,
	GetAssetPerformanceOptimizedQueryVariables
>;
export const GetPortfoliosWithAnalyticsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetPortfoliosWithAnalytics" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
								...
								{ kind: "Field", name: { kind: "Name", value: "updatedAt" } },
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "averagePurchasePrice" },
											},
											{
												kind: "Field",
												name: { kind: "Name", value: "ownershipPct" },
											},
										],
									},
								},
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "totalGainLoss" },
											},
											{
												kind: "Field",
												name: { kind: "Name", value: "totalGainLossPercent" },
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "performanceHistory" },
												selectionSet: {
													kind: "SelectionSet",
													selections: [
														{
											...
											},
											{
												...
												selectionSet: {
													...
													selections: [
														...
														{
															kind: "Field",
															name: { kind: "Name", value: "sharpeRatio" },
														},
														{
															kind: "Field",
															name: { kind: "Name", value: "maxDrawdown" },
														},
													],
												},
											},
...
export const PortfolioUpdateSubscriptionDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "subscription",
			name: { kind: "Name", value: "PortfolioUpdateSubscription" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "portfolioUpdates" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "userID" },
	...
	PortfolioUpdateSubscriptionSubscription,
	PortfolioUpdateSubscriptionSubscriptionVariables
>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				},
				{
					...
					type: {
						kind: "NamedType",
						name: { kind: "Name", value: "AssetOrder" },
					},
				},
			],
			selectionSet: {
...
export const GetAssetTypesDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetAssetTypes" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "assetTypes" },
						selectionSet: {
							kind: "SelectionSet",
							selections: [
								{ kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetAssetTypesQuery, GetAssetTypesQueryVariables>;
export const AddAssetToPortfolioDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "AddAssetToPortfolio" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "PortfolioAssetInput" },
						},
					},
				},
			],
	...
	AddAssetToPortfolioMutation,
	AddAssetToPortfolioMutationVariables
>;
export const RemoveAssetFromPortfolioDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "RemoveAssetFromPortfolio" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
	...
	RemoveAssetFromPortfolioMutation,
