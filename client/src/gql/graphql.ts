...
export type StartLocalPackBuildMutation = { __typename?: 'Mutation', startLocalPackBuild: { __typename?: 'MarketDataPackBuildJob', id: string, packId: string, sourceProvider: string, status: string, progressPercent: number, currentSymbol?: string | null, totalSymbols: number, completedSymbols: number, failedSymbols: number, errorMessage?: string | null, createdAt: any, startedAt?: any | null, finishedAt?: any | null } };
...
export type CancelPackBuildJobMutation = { __typename?: 'Mutation', cancelPackBuildJob: { __typename?: 'MarketDataPackBuildJob', id: string, packId: string, sourceProvider: string, status: string, progressPercent: number, currentSymbol?: string | null, totalSymbols: number, completedSymbols: number, failedSymbols: number, errorMessage?: string | null, createdAt: any, startedAt?: any | null, finishedAt?: any | null } };
...
export type GetPackBuildJobQuery = { __typename?: 'Query', packBuildJob?: { __typename?: 'MarketDataPackBuildJob', id: string, packId: string, sourceProvider: string, status: string, progressPercent: number, currentSymbol?: string | null, totalSymbols: number, completedSymbols: number, failedSymbols: number, errorMessage?: string | null, createdAt: any, startedAt?: any | null, finishedAt?: any | null } | null };
...
export type GetPackBuildJobsQuery = { __typename?: 'Query', packBuildJobs: Array<{ __typename?: 'MarketDataPackBuildJob', id: string, packId: string, sourceProvider: string, status: string, progressPercent: number, currentSymbol?: string | null, totalSymbols: number, completedSymbols: number, failedSymbols: number, errorMessage?: string | null, createdAt: any, startedAt?: any | null, finishedAt?: any | null }> };
